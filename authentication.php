        ...
        $("document").ready(function() {
            ...
            $('#input-email-register').focusout(function(){
                if ($(this).val() !== ''){
                    ...
                    //jQuery post method for email validation
                    $.post('register.php', {checkEmail: 'ok',email: $(this).val()})
                        .done(function(msg){
                            ...
                            else if(msg['message'] == 'Account is reserved!'){
                                $("#emailState").show();
...
<div class="container">
    <div class="login-container form card">
        ...
        <form>
            ...
            <button type="submit" class="btn btn-success btn-block" id="button-login">Sign in</button>
        </form>
    ...
    <div class="register-container form card">
        ...
        <form style="width: 300px;">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="input-email-register" placeholder="Enter email" >
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="input-password-register" placeholder="Enter password">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="input-birthdate" placeholder="dd-mm-yyyy">
            </div>
